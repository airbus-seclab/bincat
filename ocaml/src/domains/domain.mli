...
module type T = 
	...
	false otherwise *)
      ...
      val set_memory_from_config: Data.Address.t -> Data.Address.region -> Config.cvalue option * Config.tvalue option -> int -> t -> t * Taint.t
      ...
      val set_register_from_config: Register.t -> Data.Address.region -> Config.cvalue option * Config.tvalue option -> t -> t * Taint.t
