...
module type T =
    ...
    false otherwise *)
      ...
      (** set the given left value to the given addresses ; the given integer is the size of the address *)
      val set_lval_to_addrs: Asm.lval -> Data.Address.t list -> t -> t * Taint.t
